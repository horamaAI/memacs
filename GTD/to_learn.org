...
- [ ] from there, allowed to pursue other topics, but next should be:
  + [ ] have a look at: https://www.emacslife.com/baby-steps-org.html, https://sachachua.com/blog/2007/12/how-to-use-emacs-org-as-a-basic-day-planner/
  + [ ] and then visit: ==FUN MOOCS: emacs + org-mode==: "Recherche reproductible : principes méthodologiques pour une science transparente"
