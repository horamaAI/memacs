...
*perso_stuff*:
|
- organisation_org_files.org (this file) :: list structure and content of org files (to be moved, maybe right in previous folder (root))
|
...
- tutos ::
  + cpp_learnings.org ::
  + emacs_finance_hledger_learnings.org ::
  + emacs_learnings.org ::
  |
  + org-mode ::
    - 
