...
- optimize emacs startup time ::
  + run emacs as client to server :: with EmacsClient and EmacsAsDaemon
    - notes ::
    ...
    - create a daemon :: ~emacs --daemon~, or ~emacs --daemon=your_daemon_name~, or ~emacs --fg-daemon=your_daemon_name~
