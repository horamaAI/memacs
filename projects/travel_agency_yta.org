...
- YTA030 :: build-up on YTA010,
  ...
  + how to attract more customers, based on the potential of available products, and the identified needs of the clients found during phase 1 (YTA003)
    - advantages on ancillaries, subscriptions, earning miles and points, travelling in group/with kids, retailing, etc.
  + main customers to earn loyalty are those travelling from/to Africa, but can extend that definition to "African" travellers in general
** Phase 3 (000). maintenance, handovers, professionalisation, and division of labour on each main speciality
