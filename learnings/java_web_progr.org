...
- Setters injection :: injection with setter method calls inside of a bean
  ...
  public CustomerService getCustomerService() {
      ...
      customerService.setCustomerService(getCustomerRepository());
...
- process of using spring java configuration :: need to call application context to use spring
  ...
  + fetching a bean :: with method "getBean". Preferably choose the one that does type casting ==getBean(Class<T> aClass)-> T==
