...
- @Entity(name = "sessions") ::
  ...
  + modeling database relations ::
    - many to many bidirectional ::
      + use of list, need to select owner of the database relationship (in java, since a many-to-many relationship doesn’t really have an owner side in the database,), to set join tables configurations, and the configuration on the receiving end)
