...
- rename file (using dired) ::
  ...
  4. rename file
  5. confirm :: ==C-c C-c==
*** file search and replace, and filtering
- search and replace ::
...
** org-mode
*** editing/navigating headlines (or sections) and items
- editing ::
  + add headline :: =C-RET=
  + add item :: =M-RET=
...
*** org agenda, capture, refiling, todo items, and clocking
**** org agenda
...
- set default timing in a headline for default clocking ('**Organisation' for mine)
...
*** Moving cursor relative to paragraph/section/etc.
- words ::
...
- insert link :: C-c C-l, and follow instructions
  + ex (no backslash escape): \[\[https://www.youtube.com/watch?v=SzA2YODtgK4\]\[source video\]\], gives: [[https://www.youtube.com/watch?v=SzA2YODtgK4][source video]]
