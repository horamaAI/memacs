...
- process in a nutshell ::
  1. start with a packaged app (containerized app: make it run as a container)
  2. and the packaged app is given to k8s cluster
     - k8s cluster can be made of :: 1+ control plane nodes (brains of cluster, the /managers/: do tasks scheduling, monitoring, responding to events, etc.), and a bunch of workers
**** Control plane nodes
