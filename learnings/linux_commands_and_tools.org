...
- source (~./~) vs ~bash~ ::
  + source: reads and executes in current shell environment commands from file specified as argument
  + bash: invoke new shell and execute file given as argument
- set vs export ::
