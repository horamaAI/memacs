  ...
  + structure ::
    ...
    - lists ::
      ...
      + embedded lists: (json: ~[“Flour”, “Salt”, “Water”, {“Sugar”: [“caster”, “granulated”, “icing”]}]~)
        ...
        ...
        #+end_example
** jq and yq (json and yaml files parser and processor)
...
** yamllint, schema based yaml files validators, but also customisable
[2024-08-25 Sun 00:11]
- notes:
  + yamllint: much stricter standard and highly customisable: “yamllint does not only check for syntax validity, but for weirdnesses like key repetition and cosmetic problems such as lines length, trailing spaces, indentation, etc”
  + can configure style using rules in a config file to fit needs and standards (perfect for CI/CD pipelines)
  + yamllint has limits, such as being slower when substantial amount of yaml files and sets of schemas to process, but exists alternatives (but potentially more complex) able to overcome the issue, such as https://github.com/23andMe/Yamale (enforces further rigid rules, and allow parallel yaml processing files and further security checking)
* git
