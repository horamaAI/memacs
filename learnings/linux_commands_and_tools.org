...
- primitive :: string (for dates and files too), number, integer, boolean, array, object, ==nullable== attribute for potential null values
...
- objects ::
  ...
  + ==properties== is used to define object properties
    #+begin_example
    type: object
    properties:
      id:
