...
- angular modules capabilities :: (within @NgModule decorator)
  + declares :: component, pipe, and directives that it manages
    - every created component, pipe, and directive must belong to one and only one angular module
...
[2023-12-20 Wed 10:47]
- notes ::
  + the root angular module bootstraps AppComponent to provide the directive used in the index.html (insert AppComponent selector/directive in the starting point of the application
