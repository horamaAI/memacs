...
- first basic but of course very useful org mode settings ::
	...
	(add-hook 'org-mode-hook
	          '(lambda ()
	             ...
	             (org-defkey org-mode-map "\C-c[" 'undefined) ;; manually adding to 'org-agenda-files' is better than the automatic version that could mess up previous configurations of list of directories used for the files contributing to the agenda
...
;; activate M-x c++-mode for .h files that won't be opened as c++ files by default, but rather c files
